...
The analysis included in this notebook consist of:
...
### Calculate magnitude of differential splicing
```{r calculated_dPSI}

filtered_psi_table_wide <- cancer_type_psi_table_filtered |>
  tidyr::pivot_wider(names_from = pos_id,
                     values_from = PSI)
