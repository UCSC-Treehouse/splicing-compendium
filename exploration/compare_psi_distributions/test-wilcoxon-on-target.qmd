...
This exploratory notebook performs alternative splice analysis on arbitrary reference and query groups from the cancer types present in the TARGET pilot samples.
Alternative splice analysis consists of:
