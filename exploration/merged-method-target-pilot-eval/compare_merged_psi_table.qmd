...
```{r rep1_vs_rep2_unshared_event_examples}
#| label: tbl-rep1_vs_rep2_unshared_events
#| tbl-cap: "Example features of splice events not shared between rep1 and rep2 tables"
...
Between rep1 and rep2, events that are unshared also appear to be events witht he same position IDs, but assigned to different genes
