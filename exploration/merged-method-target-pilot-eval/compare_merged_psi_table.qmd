...
join_tables_no_genes <- function(table1, table2) {
  ...
  dplyr::mutate(
    ...
    table1_only = is.na(gene_it_table2),
    table2_only = is.na(gene_it_table1),
    shared_event = !(table1_only | table2_only)
    gene_difference = shared_event & gene_id_table1 != gene_id_table2,
  )
