...
shiba_junctions |>
  dplyr::filter(chr == "chr10",
                between(as.double(start), 112447467 - 20, 112447467 + 20)) |>
  knitr::kable(format = "markdown")
```
...
shiba_junctions |>
  dplyr::filter(chr == "chr12",
                between(as.double(start), 98735634 - 20, 98735634 + 20)) |>
  knitr::kable(format = "markdown")
```
...
shiba_junctions |>
  dplyr::filter(chr == "chr8",
                between(as.double(start), 144510015 - 20, 144510015 + 20)) |>
  knitr::kable(format = "markdown")
```
...
shiba_junctions |>
  dplyr::filter(chr == "chr3",
                between(as.double(start), 44862527 - 20, 44862527 + 20)) |>
  knitr::kable(format = "markdown")
```
