...
compare_zero_junctions <- dplyr::full_join(
  ...
  dplyr::mutate(
    ...
    SRR601500_combined = as.integer(SRR601500_combined),
    SRR601500_separate = as.integer(SRR601500_separate),
    SRR604528_combined = as.integer(SRR604528_combined),
    SRR604528_separate = as.integer(SRR604528_separate),
    match_type =
      dplyr::case_when(
...
```
In conclusion, not all junctions that are NA in the separate table are 0 in the combined table, but the majority of the junctions are.
