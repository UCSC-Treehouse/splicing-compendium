...
```
All the junction counts in these ranges are below 10bp.
In cases where there are values for both samples, Shiba would have given the samples an NA PSI value due to there not being enough read support for PSI calculation.
