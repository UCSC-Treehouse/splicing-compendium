...
For skipped exon events, the first coordinate spans the intron of the exclusion event (intron_c of [this diagram](https://sika-zheng-lab.github.io/Shiba/output/shiba/#psi_setxt)) and the second coordinate spans the exon of the inclusion event.
