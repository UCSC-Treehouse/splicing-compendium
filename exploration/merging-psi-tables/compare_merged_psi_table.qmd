...
Start by counting the number of events that are annotated vs. unannotated that are different
```{r}
...
Weirdly, several events look like they have the same info for both tables, e.g. 
SE@chr10@119580471-119580846@119580010-119581922
