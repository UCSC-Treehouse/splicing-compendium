...
# merged shiba PSI table of two samplesß
...
merged_splice_results_path <- "two-samples-together/results/splicing"
...
# merge the two tables to compare PSI values
comparison_table <- combined_splice_results_ref |>
  dplyr::full_join(merged_psi_table)
```
