...
The number of shared unannotated AFE events in @fig-splice_events_breakdown is \~40,000 so we seem to get most of those AFE events if we ask for splice events that are shared in 5 or more samples.
The reduction in unannotated SE events is small too - we go from around 20,000 in @fig-splice_events_breakdown, to slightly under 20,000 here.
