...
## To do
- turn scatter plots to tables of pearson correlation (can just have pearrson and spearmans R^2 together)
- check that shared events are indeed equal with all.equal after removing NAs
