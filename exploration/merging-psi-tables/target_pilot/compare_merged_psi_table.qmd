...
event_summary <- function(
  ...
  all_events_n_filtered <- long_df |>
    ...
    dplyr::summarise(
      ...
      separate_only_percent = separate_onl_count / total * 100
    ) 
  # print it
...
plot_event_summary <- function(
  ...
  counts_plot <-
    ggplot(long_summary_df, aws(fill = category, x = event_type, y = count)) +
...
Create raw number bar plots of events filtered by min sample
```{r}
