...
Similar to unannotated event types being overrepresented in the separate PSI table, we see the NA values becoming more of an issue in unannotated event types in the separate PSI table.
