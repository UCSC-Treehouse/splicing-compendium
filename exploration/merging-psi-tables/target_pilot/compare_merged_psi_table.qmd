...
correlation_df <- all_events_by_method |>
  dplyr::summarize(
    .by = event_type,
    # so correlation coefficients are overestimated here because we remove incomplete observations
...
```{r}
#| label: fig-combined_only_psi_dist
#| fig-width: 11
#| fig-height: 8
...
```{r}
#| label: fig-separate_only_psi_dist
#| fig-width: 11
#| fig-height: 8
