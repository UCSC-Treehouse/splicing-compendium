...
```
As expected, we have more observations of quantified unannotated PSI values in the combined table
...
Histogram of events dropped due to insufficient transcript representation
...
```
I mainly see that these missing values are present more in the unannotated events
## How many of each splice event types are quantified?
