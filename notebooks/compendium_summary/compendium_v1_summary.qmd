...
```{r}
#| label: fig-sample_dist_bar
#| fig-width: 15
#| fig-height: 8

ggplot(cleaned_target_df, aes(x = tissue_type, fill = tissue_type)) +
  geom_bar() +
  labs(title = "Tissue type composition of splice compendium v1", 
        x = "Tissue type", 
        y = "Count") +
  # manually add to ylim so that there is space for over-bar labels
  ylim(0, 500) +
  plot_theme +
  facet_grid(vars(tissue_type),
