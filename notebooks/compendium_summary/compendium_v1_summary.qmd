...
ggplot(merged_compendium_df, aes(x = tissue_type, fill = tissue_type)) +
  geom_bar() +
...
ggplot(merged_compendium_df, aes(x = age_in_years, fill = age_in_years)) +
  geom_bar(
