...
Exclude GTEx pilot samples for compendium summary, as these consist of a random subset of all GTEx tissue types (not just select comparator tissue types)
