...
target_compendium_df <- target_metadata |>
  ...
  dplyr::select(
    ...
    age_in_years = age_at_earliest_diagnosis_in_years.diagnoses.xena_derived,
...
gtex_compendium_df <- gtex_metadata |>
  ...
  dplyr::select(
    ...
    Run, # accession ID
    BioSample, # sample-specific accession ID from dbgap
    age_in_years = AGE, # in 10-year bins
...
Merge GTEx and TARGET metadata tables for analysis
```{r merge_metadata}
