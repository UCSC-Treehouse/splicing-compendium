...
- TARGET SRA table, for pediatric cancer bulk RNA-seq to download. 
These sequences will be used as a query group for performing differential splicing
...
From Maryke's work, we also learned that a subset of the TARGET ALL phase 2 expansion is ribo-D. 
These samples are described in [Liu et al. 2017](https://pmc.ncbi.nlm.nih.gov/articles/PMC5535770/#S11). 
