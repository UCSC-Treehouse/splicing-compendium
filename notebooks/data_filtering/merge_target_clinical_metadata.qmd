...
These cases are handled by duplicating the clinical metadata for the samples that come from the same patient (don't assume one-to-one relationship in merge).
