...
Test combining psi values

```{r}

combined_splice_list <- purrr::map(splice_results, dplyr::bind_rows, .id = "event_type")

super_combined_splice_list <- dplyr::bind_rows(combined_splice_list, .id = "sample")
